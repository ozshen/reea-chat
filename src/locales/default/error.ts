export default {
  ...
  response: {
    ...
    InvalidAccessCode: '请输入正确的访问密码，或者添加自定义 API Key',
    LocationNotSupportError: '很抱歉，此模型服务不可用，可能是由于地区限制或服务未开通',

    OpenAIBizError: '请求 OpenAI 服务出错，请根据以下信息排查或重试',
    NoOpenAIAPIKey: 'OpenAI API Key 不正确或为空，请检查 OpenAI API Key 后重试',
