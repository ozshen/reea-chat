export default {
  ...
  analytics: {
    telemetry: {
      desc: '通过选择参与产品改进计划，你可以帮助我们改善 ChatAI 整体用户体验',
      title: '发送匿名使用数据',
    },
    title: '数据统计',
  },
  ...
  llm: {
    ...
    ollama: {
      ...
      customModelName: {
        ...
        placeholder: 'vicuna,llava,codellama,llama2:13b-text,gamma:7b',
        title: '自定义模型名称',
      },
      endpoint: {
        desc: '地址必须包含 http(s)://',
  ...
  sync: {
    ...
    warning: {
      message: '本功能目前仍为实验性功能，可能存在预期外或不稳定的情况。',
    },
    webrtc: {
      channelName: {
